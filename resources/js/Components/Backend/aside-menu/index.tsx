...
export default function AsideMenu() {
    ...
    const { menuOpen, setMenuOpen } = useBackendContext();
    ...
    return (
        ...
        >
            <div
                className="fixed md:hidden inset-0 z-20 bg-black/50 backdrop-blur-sm cursor-pointer"
                    ...
                    <div className="menu">
                        ...
                        <div ref={extend_menu} className="extend_menu">
                            <div className="extend_menu__struct">
                                <NavLink
                                    to={""}
                                    className="extend_menu_item active"
                                >
