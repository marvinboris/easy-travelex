export default function GeneralStats() {
  return (
    <div className="containerStats !grid grid-cols-1 gap-4 md:grid-cols-4">
      ...
      <div className="stat_item">
        <div className="stat_item__struct">
          <div className="title">Total expenses (AED)</div>
          <div className="value">
            <div className="val">3,499.00</div>
            <div className="ico">
              <svg
                width={31}
                height={24}
      ...
      <div className="stat_item">
        <div className="stat_item__struct">
          <div className="title">Total income (AED)</div>
          <div className="value">
            <div className="val">25,233.98</div>
            <div className="ico">
              <svg
                width={31}
                height={32}
